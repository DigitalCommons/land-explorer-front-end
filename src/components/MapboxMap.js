...
const Map = ReactMapboxGl({
    accessToken: "pk.eyJ1Ijoiam9vbHp0IiwiYSI6ImNqYWpxNjJzOTJ3c2wzMm5pa3d6NWZ4bzAifQ.uh0IvJ8ggnsowL3GYhk5mg",
    scrollZoom: true,
    dragRotate: false,
    minzoom: 6,
    maxzoom: 11,
    ...
    onDrawCreate = (e) => {
        ...
        */
        if (!this.props.loadingDrawings) {
            ...
            let line = type === 'Polygon' ? turf.polygonToLine(featureCopy.geometry) : featureCopy;
            let name = type === 'Polygon' ? `Polygon ${this.props.polygonCount}` : `Line ${this.props.lineCount}`;

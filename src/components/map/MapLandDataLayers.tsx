    ...
    <React.Fragment>
      ...
      <Layer
        ...
        paint={{
          ...
          "fill-opacity":
            landDataLayers.indexOf("provisional-agricultural-land-ab795l") !==
            -1
              ? 0.4
              : 0,
        }}
      ...
      <Layer
        ...
        paint={{
          ...
          "fill-opacity":
            landDataLayers.indexOf("national-forest-estate-soil-g-18j2ga") !==
            -1
              ? 0.4
              : 0,
        }}
      ...
      <Layer
        ...
        paint={{
          ...
          "fill-opacity":
            landDataLayers.indexOf("historic-flood-map-5y05ao") !== -1
              ? 0.4
              : 0,
        }}
      />
      <Layer
        ...
        paint={{
          ...
          "fill-opacity":
            landDataLayers.indexOf("sites-of-special-scientific-i-09kaq4") !==
            -1
              ? 0.4
              : 0,
        }}
      ...
      <Layer
        ...
        paint={{
          ...
          "fill-opacity":
            landDataLayers.indexOf("special-protection-areas-engl-71pdjg") !==
            -1
              ? 0.4
              : 0,
        }}
      ...
      <Layer
        ...
        paint={{
          ...
          "fill-opacity":
            landDataLayers.indexOf("special-areas-of-conservation-bm41zr") !==
            -1
              ? 0.4
              : 0,
        }}
      ...
      <Layer
        ...
        paint={{
          ...
          "fill-opacity":
            landDataLayers.indexOf("local-authority-greenbelt-bou-9r44t6") !==
            -1
              ? 0.4
              : 0,
        }}
      ...
      <Layer
        ...
        paint={{
          ...
          "fill-opacity":
            landDataLayers.indexOf("ncc-brownfield-sites") !== -1 ? 0.4 : 0,
        }}
      />
      <Source
        tileJsonSource={{
      ...
      <Layer
        ...
        paint={{
          ...
          "line-width": 3,
          "line-opacity":
            landDataLayers.indexOf("county-4ef4ik") !== -1 ? 1 : 0,
        }}
      />
      <Source
        tileJsonSource={{
      ...
      <Layer
        ...
        paint={{
          ...
          "line-width": 3,
          "line-opacity":
            landDataLayers.indexOf("westminster_const_region-8r33ph") !== -1
              ? 1
              : 0,
        }}
      />
      ...
      <Layer
        ...
        paint={{
          ...
          "line-width": 3,
          "line-opacity":
            landDataLayers.indexOf("district_borough_unitary_regi-bquzqt") !==
            -1
              ? 1
              : 0,
        }}
